...
static const char *const yytname[] =
{
  ...
  "prog_instr", "expr", "cte", YY_NULLPTR
};
#endif
...
#line 35 "parser.y" /* yacc.c:1646  */
    {char buffer [100]; snprintf(buffer,100,"%s\n\tsyncall",(yyvsp[0].string_val)); (yyval.string_val) = buffer;}
